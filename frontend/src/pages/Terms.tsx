    ...
    <div className="container max-w-3xl mx-auto py-16 px-4">
      ...
      <div className="prose prose-sm max-w-none">
        <Section title="1. Acceptance of Terms">
          <p>By accessing or using the LuxeStay platform ("Service"), you agree to be bound by these Terms of Service. If you do not agree, please discontinue use immediately.</p>
        </Section>
        ...
        <Section title="3. Booking & Payments">
          <p>All bookings made through LuxeStay are subject to availability and confirmation. Prices shown are inclusive of applicable taxes unless otherwise stated. Payment is processed securely via Razorpay.</p>
          <p>LuxeStay acts as an agent between guests and hotels. Each hotel's individual policies regarding check-in, check-out, and amenities apply.</p>
        </Section>
        ...
        <Section title="5. Intellectual Property">
          <p>All content on the LuxeStay platform — including text, graphics, logos, and software — is the property of LuxeStay Hospitality Pvt. Ltd. and is protected by applicable intellectual property laws.</p>
        </Section>
        <Section title="6. Limitation of Liability">
          <p>To the maximum extent permitted by law, LuxeStay shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your use of the Service.</p>
        </Section>
        ...
        <Section title="9. Contact">
          <p>For questions regarding these Terms, please contact us at <a href="mailto:legal@luxestay.com" className="text-primary hover:underline">legal@luxestay.com</a>.</p>
        </Section>
      </div>
    </div>
  </Layout>
