          ...
          <div className="space-y-5">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              <Field label="Phone Number" error={errors.phone?.message}>
                <input {...register("phone", { required: "Phone number is required", pattern: { value: /^\+?[\d\s\-()]{7,20}$/, message: "Please enter a valid phone number" } })}
                  placeholder="+1 (555) 123-4567" className="w-full px-4 py-2.5 border border-border rounded-lg outline-none focus:ring-2 focus:ring-primary focus:border-primary text-sm" />
              </Field>
            </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                      ...
                      <Field label="Phone Number" error={errors.adults?.[index]?.phone?.message}>
                        <input {...register(`adults.${index}.phone`, { required: "Phone number is required", pattern: { value: /^\+?[\d\s\-()]{7,20}$/, message: "Please enter a valid phone number" } })}
                          placeholder="+1 (555) 123-4567" className="w-full px-4 py-2.5 border border-border rounded-lg outline-none focus:ring-2 focus:ring-primary focus:border-primary text-sm" />
                      </Field>
                    </div>
                    <Field label="Special Requests (optional)">
