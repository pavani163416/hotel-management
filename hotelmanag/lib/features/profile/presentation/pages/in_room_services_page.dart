...
class _InRoomServicesPageState extends State<InRoomServicesPage> {
  ...
  final Map<String, List<ServiceItem>> _services = {
    'Housekeeping': [
      const ServiceItem(
        id: 'h1',
        name: 'Fresh Towels Set',
        description: '2 bath towels, 2 hand towels',
        price: 0.0,
        icon: LucideIcons.wind,
      ),
      const ServiceItem(
        id: 'h2',
        name: 'Extra Feather Pillows',
        description: 'Set of 2 luxury pillows',
        price: 5.0,
        icon: LucideIcons.box,
      ),
      const ServiceItem(
        id: 'h3',
        name: 'Room Turn-Down Service',
        description: 'Bed making, fresh water, tidying',
        price: 15.0,
        icon: LucideIcons.sparkles,
      ),
      const ServiceItem(
        id: 'h4',
        name: 'Premium Toiletries Pack',
        description: 'L\'Occitane soap, shampoo, lotion',
        price: 8.0,
    ...
    'In-Room Dining': [
      const ServiceItem(
        ...
        description: 'Croissant, juice, coffee, eggs',
        price: 20.0,
      ...
      const ServiceItem(
        ...
        description: '750ml premium San Pellegrino',
        price: 6.0,
    ...
    'Maintenance': [
      const ServiceItem(
        id: 'm1',
        name: 'AC Temperature Check',
        description: 'AC not cooling / heating correctly',
        price: 0.0,
      ...
      const ServiceItem(
        id: 'm2',
        name: 'WiFi Trouble',
        description: 'Slow connection or login issues',
        price: 0.0,
      ...
      const ServiceItem(
        ...
        description: 'Broken bulb in bedroom or bathroom',
        price: 0.0,
        icon: LucideIcons.lightbulb,
      ),
      const ServiceItem(
        id: 'm4',
        name: 'TV Remote / Channel Setup',
                  ...
                  children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            item.price == 0
                                ? 'Complimentary'
                                : currencyProvider.format(item.price),
                            style: TextStyle(
                              fontSize: 12.5,
                              fontWeight: FontWeight.bold,
                              color: item.price == 0
                    ...
                    IconButton(
                      icon: Icon(
                        ...
                        color: inCart ? Colors.red : AppTheme.primaryColor,
                      ),
                      onPressed: () {
                        setState(() {
                          if (inCart) {
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      '${_cart.length} Request items selected',
                      style: const TextStyle(fontSize: 13, color: Colors.grey),
                    ),
                    Text(
                      'Total: ${currencyProvider.format(_totalPrice)}',
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: AppTheme.primaryColor,
      ...
      child: Column(
        children: [
          ...
          _buildTrackerStep(
            ...
            'Your concierge ticket #LS-8291 has been created.',
          ...
          _buildTrackerStep(
            ...
            'Staff are organizing your requested service items.',
