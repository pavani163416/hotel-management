...
export function buildCspDirectives({ nonce, includeSwagger = false } = {}) {
  ...
  const directives = [
    ...
    `connect-src 'self' ${RAZORPAY_ORIGINS.join(" ")} ${GOOGLE_ORIGINS.join(" ")} https://countriesnow.space https://ipapi.co https://freeipapi.com https://hotel-management-production-2225.up.railway.app wss://hotel-management-production-2225.up.railway.app ws://localhost:5000 http://localhost:5000`,
